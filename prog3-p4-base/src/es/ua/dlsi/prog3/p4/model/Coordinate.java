...
public class Coordinate {
    ...
    public Coordinate sum(Coordinate c) {
        if (
            !checkInRange(this.x + c.x) || !checkInRange(this.y + c.y)
        ) throw new ArithmeticException(
            "sum of coordinates results in out of range values: (" +
            (this.x + c.x) +
            "," +
            (this.y + c.y) +
            ")"
    ...
    public Coordinate subtract(Coordinate c) {
        if (
            ...
            "subtracting coordinates results in out of range values: (" +
            (this.x - c.x) +
            "," +
            (this.y - c.y) +
            ")"

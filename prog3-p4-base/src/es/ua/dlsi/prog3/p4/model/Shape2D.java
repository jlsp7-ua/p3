...
/**
 * Clase abstracta raíz de la jerarquía de las clases que modelan
 * las figuras bidimensionales. Se conforma de una posición en el plano
 * mediante la clase Coordinate.
 * @author solve
 */
...
public abstract class Shape2D {
    ...
    protected Shape2D(Shape2D s) {
        coordinate = new Coordinate(s.coordinate);
    }
     ...
     * @param s es el factor de escala, 100 es mismo tamaño
     */
